...
app.get(`${baseApiUrl}/hello/:name`, authMiddleware.authenticate(types_1.SecurityStrategies.AUTH_CODE), (request, response) => {
...
//# sourceMappingURL=oauth-user-signin.js.map