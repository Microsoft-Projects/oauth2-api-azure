...
const oauth = __importStar(require("../../../lib/src/index"));
const authentication = __importStar(
  require("../../../lib/src/middleware/security/authentication")
);
const types_1 = require("../../../lib/src/types");
...
app.get(
  ...
  authMiddleware.authenticate(types_1.SecurityStrategies.AUTH_CODE),
  (request, response) => {
...
function validateUserRoleCallback(
  request,
  user,
  issuer,
  sub,
